...
const changeMode = (mode) => {
  if (mode === 'dark') {
    ...
    document.querySelector('h3').style.color = '#cccccc'

    mainBody.style.backgroundColor = '#1e1e1e'
    localStorage.setItem('mode', 'dark')

    iconBody.style.fill = '#E6E6E6'
    document.querySelector('.moon-graphic').style.filter =
      'drop-shadow(1px 1px 20px  #b2b2b183)'
    ...
    document.querySelector('h3').style.color = '#3f3f3f'

    mainBody.style.backgroundColor = '#f2f2f2'
    localStorage.setItem('mode', 'light')

    document.querySelector('.moon-graphic').style.filter =
      'drop-shadow(1px 1px 25px  #f5b833)'
